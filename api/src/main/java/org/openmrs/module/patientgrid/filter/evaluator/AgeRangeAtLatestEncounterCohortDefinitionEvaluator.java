...
public class AgeRangeAtLatestEncounterCohortDefinitionEvaluator implements CohortDefinitionEvaluator {
  ...
  /**
   * Will use a the PatientData evaluator {@link org.openmrs.module.patientgrid.evaluator.AgeAtLatestEncounterPatientDataEvaluator} via {@link AgeAtLatestEncounterPatientDataDefinition}
   * to filter the patients ( based on their age and if they have an encounter)
   *
